 ...
 * @author Lenovo
 */
public class AdminPaymentReceipt extends javax.swing.JFrame {

    /**
     * Creates new form AdminPaymentReceipt
     */
    public AdminPaymentReceipt() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Select Booking To Generate Receipt");
    ...
    private void ReceiptTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ReceiptTableMouseClicked
        ...
        int reply = JOptionPane.showConfirmDialog(null, "Are you sure you want to collect payment for the selected account?", "Comfirmation", JOptionPane.YES_NO_OPTION);
        if (reply == JOptionPane.YES_OPTION) {
            //approve function
            Boolean result = Admin.CollectPayment(model.getValueAt(selectedRowIndex, 0).toString(),model.getValueAt(selectedRowIndex, 1).toString());
            if (result == true) {
                this.setVisible(false);
                this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPaymentReceipt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminPaymentReceipt().setVisible(true);
            }
        });
    }
