...
public class CustomerFeedback extends javax.swing.JFrame {
    ...
    public CustomerFeedback() {
        ...
        //create table model
        DefaultTableModel table = (DefaultTableModel) FeedbackTable.getModel();
        //load table
        Customer.LoadFeedbackTable(table);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Select a car for rating and feedback!");

        FeedbackTable.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        jLabel3.setText("Let us know your experience so that we could improve our services!");
        ...
        Rating.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "none", "1", "2", "3", "4", "5" }));
