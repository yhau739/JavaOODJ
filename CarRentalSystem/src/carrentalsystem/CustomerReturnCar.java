 ...
 * @author leere
 */
public class CustomerReturnCar extends javax.swing.JFrame {

    /**
     * Creates new form CustomerReturnCar
     */
    public CustomerReturnCar() {
        initComponents();
        
        JTableHeader tableHeader = BookedTable.getTableHeader();
        ...
        //create table model
        DefaultTableModel table = (DefaultTableModel) BookedTable.getModel();

        //load table
        Customer.LoadReturnTable(table);
    }
    ...
    private void initComponents() {
        ...
        BookedTable.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        BookedTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Car Plate", "Start Date ", "Duration", "End Date"
            }
        ) {
        ...
        jLabel3.setText("Choose a booked car from the table below to return.");
        ...
        jLabel16.setText("Selected booking details.");
    ...
    private void BookedTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BookedTableMouseClicked
        ...
        int selectedRowIndex = BookedTable.getSelectedRow();
    ...
    private void ReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReturnActionPerformed
        ...
        Boolean result = Customer.ReturnCar(plate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerReturnCar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerReturnCar().setVisible(true);
            }
        });
    }
